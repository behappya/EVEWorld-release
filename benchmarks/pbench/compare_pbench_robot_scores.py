...
def main() -> None:
    ...
    parser.add_argument("--paper-domain", type=float, default=PAPER_DOMAIN)
    parser.add_argument("--paper-overall", type=float, default=PAPER_OVERALL)
    args = parser.parse_args()

    paper_domain = args.paper_domain
    paper_overall = args.paper_overall
    paper_quality_inferred = 2 * paper_overall - paper_domain
