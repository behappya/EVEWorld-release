...
VIDEO_DIR="${VIDEO_DIR:-/data/datasets/gagi/giga_world_0_outputs/pbench_robot_length_sweep/pbench_robot_15p8s_full_pbench_len_sweep_full_8gpu}"
EVAL_DIR="${EVAL_DIR:-/data/datasets/gagi/giga_world_0_outputs/pbench_robot_qwen_vqa_eval/pbench_robot_15p8s_full_pbench_len_sweep_full_8gpu_domain_qwen36vl_58_think32000}"
