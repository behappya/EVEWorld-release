...
def _diffusers_weight_format_kwargs(model_path):
...
class GigaWorld0Pipeline(DiffusionPipeline):
    ...
    def from_pretrained(
        ...
        transformer = GigaWorld0Transformer3DModel.from_pretrained(
            transformer_model_path,
            **_diffusers_weight_format_kwargs(transformer_model_path),
        )
